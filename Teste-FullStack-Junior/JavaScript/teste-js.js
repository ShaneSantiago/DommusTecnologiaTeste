...
async function separarPorIdade(pessoas){
  ...
  const arrayPessoas = pessoas.map((pessoa, i) => {
    if(pessoa.idade % 2 == 0){
      par++
      nomesPar.push(pessoa.nome)
    }
...
separarPorIdade(pessoas).then((resposta) => {
  ...
  console.log(`Nomes de pessoas com idade par são: ${resposta.par}`)
  // TODO imprimir no console a quantidade de nomes de pessoas com idade impar. Saída esperada: 7
  console.log(`Nomes de pessoas com idade impar são: ${resposta.impar}`)
  ...
  console.log(`Nomes de pessoas com idade ordem alfabetica são: ${resposta.nomesPar}`)
  ...
  console.log(`Nomes de pessoas com idade impar ordem alfabetica são: ${resposta.nomesImpar}`)
})
